...
export const quoteConfig: apiConfigInterface = {
    stockQuote: {
        ...
        required: ["symbol"],
        description:
            "Access real-time stock quotes with the FMP Stock Quote API. Get up-to-the-minute prices, changes, and volume data for individual stocks. Symbol Limited to US, UK, and Canada Exchanges."
    },
    stockQuoteShort: {
        ...
        required: ["symbol"],
        description:
            "Get quick snapshots of real-time stock quotes with the FMP Stock Quote Short API. Access key stock data like current price, volume, and price changes for instant market insights. Symbol Limited to US, UK, and Canada Exchanges."
    },
    aftermarketTrade: {
    ...
    stockPriceChange: {
        ...
        required: ["symbol"],
        description:
            "Track stock price fluctuations in real-time with the FMP Stock Price Change API. Monitor percentage and value changes over various time periods, including daily, weekly, monthly, and long-term. Symbol Limited to US, UK, and Canada Exchanges."
    },
    stockBatchQuote: {
        ...
        required: ["symbols"],
        description:
            "Retrieve multiple real-time stock quotes in a single request with the FMP Stock Batch Quote API. Access current prices, volume, and detailed data for multiple companies at once, making it easier to track large portfolios or monitor multiple stocks simultaneously. Symbol Limited to US, UK, and Canada Exchanges."
    },
    stockBatchQuoteShort: {
        ...
        required: ["symbols"],
        description:
            "Access real-time, short-form quotes for multiple stocks with the FMP Stock Batch Quote Short API. Get a quick snapshot of key stock data such as current price, change, and volume for several companies in one streamlined request. Symbol Limited to US, UK, and Canada Exchanges."
    },
