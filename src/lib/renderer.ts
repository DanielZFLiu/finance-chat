...
function getMarked(): Marked {
    ...
    md.use({
        ...
        renderer: {
            heading(token: Tokens.Heading & { id?: string }) {
    ...
    elements.forEach(element => {
        switch (element.tagName.toLowerCase()) {
            ...
            case 'td':
                ...
                break;
            case 'code':
                element.setAttribute('style', (element.getAttribute('style') || '') + 'font-family: var(--ibm-mono-plex); border-radius: 5px; font-size: 1em;');
                break;
        }
